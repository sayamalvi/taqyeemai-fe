        ...
        <FadeIn delay={0.1}>
            <div className="relative overflow-hidden bg-surface/30 backdrop-blur-xl rounded-[28px] border border-white/5 p-8 shadow-2xl">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-sm text-ink-muted mt-2">Start auditing your resumes with AI.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-ink-muted uppercase tracking-wider pl-1">Name</label>
                        <Input
                            type="text"
                            required
                            value={name}
