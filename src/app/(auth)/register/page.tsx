            ...
            <div className="glass-panel p-8 sm:p-10 rounded-3xl space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-sans font-semibold text-foreground/80 pl-1">Full Name</label>
                        <Input
                            type="text"
                            required
                            value={name}
                ...
                <div className="pt-6 font-sans text-sm text-foreground/50 border-t border-white/10 flex justify-center gap-2 items-center">
                    ...
                    <Link href="/login" className="text-primary font-medium hover:text-white transition-colors">
                        Sign in
                    </Link>
                </div>
            </div>
